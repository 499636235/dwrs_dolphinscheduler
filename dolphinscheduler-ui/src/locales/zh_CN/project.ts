...
export default {
  list: {
    ...
    edit_project: '编辑项目',
    project_list: '项目列表',
    project_code_tips: '请输入项目编号（仅限数字，非必填）',
  ...
  workflow: {
    ...
    import_update_workflow: '导入并更新工作流',
    get_workflow_name: '获取工作流名称',
    workflow_name: '工作流名称',
    workflow_batch_start_size: '工作流批量运行数量',
    ...
    batch_export: '批量导出',
    batch_up_line: '批量上线',
    batch_down_line: '批量下线',
    batch_time_up_line: '批量定时上线',
    batch_time_down_line: '批量定时下线',
    version_info: '版本信息',
    version: '版本',
    file_upload: '文件上传',
    upload_file: '上传文件',
  ...
  node: {
    ...
    task_group_name_tips: '请选择任务组名称(必选)',
